...
<p align="left">
  <a href="https://pub.dartlang.org/packages/flutter_voice_recorder"><img alt="pub version" src="https://img.shields.io/pub/v/flutter_voice_recorder.svg?style=flat-square"></a>

</p>



Flutter Voice Record Plugin that supports `Record` `Pause` `Resume` `Stop` and provide access to audio level metering properties `average power` `peak power`
...
## Installation
add `flutter_voice_recorder` to your `pubspec.yaml`
...
##### Sample Rate
```
var recorder = FlutterVoiceRecorder("file_path", audioFormat: AudioFormat.AAC, sampleRate: 22000); // sampleRate is 16000 by default
await recorder.initialized;
```
